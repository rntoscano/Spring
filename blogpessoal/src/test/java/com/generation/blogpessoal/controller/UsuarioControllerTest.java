...
class UsuarioControllerTest {
    ...
    void deveAtualizarUmUsuario() {
        ...
        String token = JwtHelper.obterToken(
                testRestTemplate,
                ADMIN,
                SENHA);

        HttpEntity<Usuario> requisicao =
                JwtHelper.criarRequisicaoComToken(
                        usuarioUpdate,
                        token);
    ...
    void deveListarTodosUsuarios() {
        ...
        HttpEntity<Void> requisicao =
                JwtHelper.criarRequisicaoComToken(token);
